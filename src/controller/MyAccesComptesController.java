...
/**
 * Servlet implementation class MyAccesComptesController
 */
@WebServlet("/MyAccesComptesController")
public class MyAccesComptesController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyAccesComptesController() {
        super();
